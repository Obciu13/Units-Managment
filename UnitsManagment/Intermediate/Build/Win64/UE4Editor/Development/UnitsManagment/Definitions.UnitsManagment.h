...
#define UE_PROJECT_NAME UnitsManagment
#define UE_TARGET_NAME UnitsManagmentEditor
#define UE_MODULE_NAME "UnitsManagment"
...
#define UNITSMANAGMENT_API DLLEXPORT
